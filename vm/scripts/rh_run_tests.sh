...
echo .......................................
sudo rm -f /tmp/ws_expirer.log
env PATH=/home/vagrant/hpc-workspace-v2/build/release/bin:$PATH /usr/local/bin/bats bats/test_setuid | tee /tmp/ws-tests/setuid-tests.out | grep failures
...
echo .......................................
sudo rm -f /tmp/ws_expirer.log
env PATH=/home/vagrant/hpc-workspace-v2/build/release/bin:$PATH /usr/local/bin/bats bats/test_cap | tee /tmp/ws-tests/cap-tests.out | grep failures
