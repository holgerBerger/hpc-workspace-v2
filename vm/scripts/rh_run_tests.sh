...
env PATH=/home/vagrant/hpc-workspace-v2/build/debug/bin:$PATH /usr/local/bin/bats -p bats/test | tee -o /tmp/ws-tests/user-tests.out | grep failures
...
echo .......................................
sudo rm -f /tmp/ws_expirer.log
env PATH=/home/vagrant/hpc-workspace-v2/build/release/bin:$PATH /usr/local/bin/bats bats/test_setuid | tee -o /tmp/ws-tests/setuid-tests.out | grep failures
...
echo .......................................
sudo rm -f /tmp/ws_expirer.log
env PATH=/home/vagrant/hpc-workspace-v2/build/release/bin:$PATH /usr/local/bin/bats bats/test_cap | tee -o /tmp/ws-tests/cap-tests.out | grep failures
